...
* BREAKING: Allow Instrumentation to be automatically included in Server-Timing headers generated by Rails. If you are currently subscribing to ActiveSupport::Notifications for `!render.view_component` please update your subscriptions to `render.view_component`.
