...
* Raise errors encountered while computing a component's cache digest, instead of silently degrading to an untracked component that can serve stale fragments.
